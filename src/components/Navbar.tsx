...
const navItems = [
  ...
  { path: "/rankings", label: "Power Rankings", icon: Users },
  { path: "/news", label: "Today's News", icon: Newspaper },
        ...
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              <span className="font-semibold text-foreground">InfluenceGraph</span>
